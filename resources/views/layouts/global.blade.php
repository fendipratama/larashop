<!DOCTYPE html> 
<!--[if IE 9]> <html class="ie9 no-js" lang="en"> <![endif]--> <!--[if (gt IE 9)|!(IE)]><!--> 
...
<body> 
    ...
    <nav class="navbar navbar-expand p-0">      
    	...
    	<input class="border-dark bg-primary-darkest form-control d-none dmd-block w-50 ml-3 mr-2" type="text" placeholder="Search" arialabel="Search">    <div class="dropdown d-none d-md-block">         
    		@if(\Auth::user())         
		...
		<div style="min-height: 100%" class="flex-row d-flex align-itemsstretch m-0">         
			<div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav"> 
            	<ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">               
            		...
            		<li>
            			<a href="{{ URL::route('home') }}"><span class="oi oi-home"></span> Home</a>
            		</li>
                    <li>
            	...
            	<div class="pl-3 d-none d-md-block position-fixed" style="bottom: 0px">  
                    ...
                    <form action="{{route("logout")}}" method="POST">               
                        @csrf               
                        <button class="dropdown-item" style="cursor:pointer"><span class="oi oi-cog"></span> Sign Out</button>             
                    </form>              
            	</div>         
            </div>         
...
<script 
	...
	integrity="sha384cs/chFZiN24E4KMATLdqdvsezGxaGsi4hLGOzlXwp5UZB1LY//20VyM2taTB4QvJ" 
	crossorigin="anonymous">
</script>   
<script 
