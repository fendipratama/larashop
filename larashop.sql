...
CREATE TABLE `books` (
  ...
  `cover` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `categories` (
  ...
  `slug` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'berisi nama file image saja tanpa path',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `deleted_by` int(11) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
(13, 'Maximus Cole', 'et-eum-eum-cupiditate', '/tmp/01c1d77b115096c1231390022fe64f42.jpg', 1, NULL, NULL, '2018-10-02 07:10:05', '2018-08-06 08:29:40', '2018-10-02 07:10:05'),
...
CREATE TABLE `orders` (
  ...
  `invoice_number` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 14, 780000.00, '201807150002', 'PROCESS', '2018-07-26 00:00:00', '2018-10-02 08:50:04');
